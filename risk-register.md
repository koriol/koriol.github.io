...
+ Impact 1 (Low): Minor inconvenience; Guest Wi-Fi goes down for 1 hour.

| Rating | Score | Definition | Business Context (New York Center) |
| --- | --- | --- | --- |
| <span style="color:rubyred">Critical</span> | 20-25 | Immediate Action Required | Potential for total loss of student PII or long-term center closure. |
| <span style="color:red">High</span> | 12-19 | Prioritized Mitigation | Significant impact on operations or a major GDPR/Privacy violation. |
| <span style="color:orange">Medium</span> | 6-11 | Planned Remediation | Noticeable impact on staff efficiency or minor financial loss.|
