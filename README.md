...
* [**View Project Hub**](./grcac_homepage.md)
> **Planned Work:**
> * **SOAR Phishing Automation:** Logic Apps for automated threat response.
> * **Global Honeypot:** Analyzing live attack vectors to inform compliance tuning.
...
* **The Impact:** Mapped technical MFA gaps and stale accounts directly to SOC 2 and NIST frameworks.
* [**View Entra Audit**](./entra_audit.md) | [**
> **Planned Work:**
> * **Modern Workplace Identity:** JumpCloud to M365 sync with CrowdStrike endpoint integration.
